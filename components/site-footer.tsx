        ...
        <div className="w-full pt-8 border-t">
          ...
          <div className="flex gap-4 md:gap-6 justify-center">
            ...
            <Button
              ...
              asChild
            >
              <Link href="https://github.com/fadiljaleel?tab=repositories" target="_blank" rel="noopener noreferrer">
          ...
          <div className="text-foreground/90 dark:text-gray-300 text-xs md:text-sm flex flex-wrap items-center justify-center gap-2 text-center px-4 mt-8">
            <Link href="/" className="hover:text-primary transition-colors">Muhammed Fadil</Link>
            <span>•</span>
            <span>© 2026</span>
            <span>•</span>
