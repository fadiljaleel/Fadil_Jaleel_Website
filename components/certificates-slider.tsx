...
export function CertificatesSlider() {
  ...
  const handleVerifyClick = (externalLink: string) => {
      ...
      <div className="container px-4 md:px-6">
        ...
        >
          ...
          <p className="text-muted-foreground md:text-lg max-w-[800px] mx-auto px-4">
            Industry-recognized certifications in AI, Machine Learning, and Data Science
          </p>
        </motion.div>
                        ...
                        >
                          <div className="relative group cursor-pointer">
                            ...
                            <div className="relative h-80 bg-white dark:bg-slate-900 rounded-lg shadow-lg overflow-hidden border border-border">
                              ...
                              {/* Verify Button - Shows on Hover */}
                              <AnimatePresence>
                                {hoveredCertIndex === globalIdx && (
                                  <motion.div
                                  ...
                                  >
                                    <Button
                                      onClick={(e) => {
                                        e.stopPropagation()
                                        handleVerifyClick(certificate.externalLink)
                                      }}
